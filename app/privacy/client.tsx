...
const quickStats = [
  ...
  { value: '30 Days', label: 'Response Time' },
  { value: 'Zero', label: 'Data Sales' },
]
                    ...
                    <nav className="space-y-0.5">
                      {tableOfContents.map((item) => (
                        <button
                          ...
                          className="block w-full text-left text-sm text-muted-foreground hover:text-primary transition-colors py-1.5 border-l-2 border-border/50 hover:border-primary pl-3 hover:bg-primary/5 rounded-r-md"
                        >
                          {item.title}
                        </button>
                      ))}
                ...
                {sections.map((section, index) => {
                  ...
                  return (
                    <motion.section
                      key={section.id}
                      id={section.id}
                      className="glass-card rounded-xl p-6 md:p-8 scroll-mt-24"
                      initial={{ opacity: 0, y: 20 }}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-xl mx-auto mb-8">
                Your privacy matters to us. If you have questions about your data, want to exercise
                your rights, or need to reach our Data Protection Officer, we&apos;re here to help.
              </p>
