# WK-DOC-027: CSM Suite Engine Architecture
...
The Wryko CSM Suite consists of six interconnected automation engines designed to fundamentally transform client success operations. These engines replace manual, reactive workflows with automated, proactive systems—enabling a single Client Success Manager to effectively manage 20-25 accounts instead of the industry standard of 8-12.
...
| Variable | Purpose |
|----------|---------|
| `WRYKO_MASTER_SHEET_ID` | Google Sheets document ID |
| `WRYKO_CLIENTS_FOLDER_ID` | Google Drive folder for client files |
| `WRYKO_PORTAL_URL` | Client portal base URL |
...
- WK-DOC-009: Troubleshooting Guide
- WK-DOC-004: Performance Metrics Guide
- WK-DOC-005: Weekly Client Report Template
