# XG-DOC-045: API Documentation
## XGrowthOS Internal API Reference

**Document ID:** XG-DOC-045
**Category:** Technology
**Version:** 1.0
...
| Environment | URL |
|-------------|-----|
| Production | https://api.xgrowthos.com |
...
```typescript
import { XGrowthOS } from '@xgrowthos/sdk';

const client = new XGrowthOS({
  apiKey: process.env.XGROWTHOS_API_KEY
});
