# WK-DOC-042: Lead Generation Engine Specifications (A-H)

**Document Type:** Operations & Technical
**Classification:** Internal / Partner-Shareable
**Version:** 1.0
**Last Updated:** January 2026
**Author:** Wryko Engineering

---

## Executive Summary

The Wryko Lead Generation Suite consists of five interconnected lead generation engines (A-H, with C, F, G designated for future expansion) designed to automate the entire outbound lead generation process. These engines handle prospect verification, campaign creation, continuous optimization, lead expansion, and website visitor intelligence. Together with the six CSM Automation engines (I-N), Wryko operates a total of eleven AI engines.
...
## The Five Lead Generation Engines at a Glance
...
- [WK-DOC-041](WK-DOC-041-System-Architecture.md): System Architecture Diagram
...
*This document is part of the Wryko operational documentation suite. For questions or updates, contact the Engineering team.*
