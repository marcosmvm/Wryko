# WK-DOC-014: Website Specification
## Wryko.com Technical & Content Requirements

**Document ID:** WK-DOC-014
**Category:** Marketing
**Version:** 2.0
...
### 1.1 Purpose
The Wryko website serves as the primary marketing and client acquisition platform, showcasing autonomous B2B lead generation capabilities and converting visitors to discovery calls.
...
| Color | Hex | Usage |
|-------|-----|-------|
| Primary | #A855F7 | CTAs, links, accents |
| Primary Hover | #9333EA | Button hover states |
...
- Wryko solution benefits
- Comparison table

**Eleven AI Engines Section:**
...
- The Informant - Automated Reports
- The Judge - Issue Detection & Auto-Healing
- The Keeper - AI Knowledge Brain
- The Launcher - Automated Onboarding
- The Monitor - Churn Risk Detection
- The Navigator - Self-Serve Portal
