# WK-DOC-041: System Architecture Diagram
## Wryko Complete Data Flow & Infrastructure

**Document ID:** WK-DOC-041
...
This document provides a comprehensive view of the Wryko technical architecture, showing how all components—from prospect data to booked meetings—flow through the system. It covers the 11 AI engines, third-party integrations, and data storage infrastructure.
...
```bash
# Application
NEXT_PUBLIC_APP_URL=https://wryko.com
NODE_ENV=production
...
- [WK-DOC-042](WK-DOC-042-Lead-Gen-Engine-Specs.md): Lead Generation Engine Specs (A-H)
- [WK-DOC-043](WK-DOC-043-Integration-Documentation.md): Integration Documentation
- [WK-DOC-014](WK-DOC-014-Website-Specification.md): Website Specification
