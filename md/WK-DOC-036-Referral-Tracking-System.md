# WK-DOC-036: Referral Tracking System Specification
## Referral Program Operations

**Document ID:** WK-DOC-036
...
This document specifies how referrals are tracked, credited, measured, and reported. It ensures accurate attribution and timely payouts for the Wryko referral program.

---

## Referral Program Overview

### Program Terms (from WK-DOC-020)
...
**Process:**
1. Client sends intro email CCing referrals@wryko.com
...
**URL Format:** wryko.com/r/{{client_code}}
...
Thanks for spreading the word about Wryko!
